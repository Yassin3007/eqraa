        ...
        <ul class="nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item" href="{{route('logout','supervisor')}}">تسجيل الخروج</a>
      ...
      <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
        ...
        <nav class="vertnav navbar navbar-light">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="{{route('supervisor_index')}}"  class="dropdown-toggle nav-link">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="{{route('supervisor_students')}}"   class="dropdown-toggle nav-link">
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="{{route('supervisor_teachers')}}"   class="dropdown-toggle nav-link">
                <i class="fe fe-file fe-16"></i>
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="{{route('teacher_rating.index')}}"   class="dropdown-toggle nav-link">
                <i class="fe fe-file fe-16"></i>
          ...
          <ul class="navbar-nav flex-fill w-100 mb-2">
            <li class="nav-item dropdown">
              <a href="{{route('rewards.index')}}"   class="dropdown-toggle nav-link">
                <i class="fe fe-file fe-16"></i>
                <span class="ml-3 item-text">مكافات وجزاءات</span>
              </a>     
            </li>
          </ul>
