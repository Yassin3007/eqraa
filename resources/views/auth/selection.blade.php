                    ...
                    <div style="border-radius: 15px;" class="col-lg-8 col-md-8 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            ...
                            <div class="form-inline">
                                <a class="btn btn-default col-lg-3" title="طالب" href="{{route('loginType','student')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/images/student.png')}}">
                                    <h5>طالب</h5>
                                </a>
                                <a class="btn btn-default col-lg-3" title="مشرف " href="{{route('loginType','supervisor')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/images/parent.png')}}">
                                    <h5>مشرف</h5>

                                </a>
                                <a class="btn btn-default col-lg-3" title="معلم" href="{{route('loginType','teacher')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/images/teacher.png')}}">
                                    <h5>معلم</h5>

                                </a>
                                <a class="btn btn-default col-lg-3" title="ادمن" href="{{route('loginType','admin')}}">
